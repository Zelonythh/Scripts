...
["HeaderShadingColor"] = Color3.fromRGB(128, 128, 128),
...
if not isfile("ZeloSpySettings.json") then
writefile("ZeloSpySettings.json", HttpService:JSONEncode(settings))
else
if HttpService:JSONDecode(readfile("ZeloSpySettings.json"))["Main"] then
writefile("ZeloSpySettings.json", HttpService:JSONEncode(settings))
else
settings = HttpService:JSONDecode(readfile("ZeloSpySettings.json"))
end
end
...
-- delete the previous instances of ZeloSpy
if game.CoreGui:FindFirstChild("ZeloSpyGUI") then
game.CoreGui.ZeloSpyGUI:Destroy()
end
...
local ZeloSpyGUI = Instance.new("ScreenGui")
...
ZeloSpyGUI.Name = "ZeloSpyGUI"

Parent(ZeloSpyGUI)

mainFrame.Name = "mainFrame"
mainFrame.Parent = ZeloSpyGUI
...
BrowserHeader.Parent = ZeloSpyGUI
...
CloseInfoFrame2.TextColor3 = Color3.fromRGB(255,255,255)
...
ZeloSpyGUI.Enabled = not ZeloSpyGUI.Enabled
end
end)
...
Code.Text = "Thanks for using ZeloSpy! :D"
...
CodeComment.Text = "-- Script generated by ZeloSpy, made by z3loo."
